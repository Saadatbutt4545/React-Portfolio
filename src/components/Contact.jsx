...
const Contact = () => {
  return (
    <div className="md:px-10 px-7 my-10" id="contact">
      ...
      {/* social icons */}
      <div className="flex ">
        <a href="https://www.linkedin.com/in/saadat-ali-907099285/" target="_blank" rel="noreferrer">
          <img src={facebook} alt="" />
        </a>
        <a className="ml-4" href="https://www.linkedin.com/in/saadat-ali-907099285/" target="_blank" rel="noreferrer">

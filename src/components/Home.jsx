            ...
            <div>
                <div className='flex flex-col md:flex-row items-center justify-between w-full'>
                    ...
                    <div className='text-white'>
                        ...
                        <h1 className='font-semibold md:text-5xl my-4 text-3xl'>SAADAT ALI</h1>
                        <p className='md:w-96'>Passionate Front End developer, & Digital Marketer. I create seamless web experiences for end-users. 
                        My First priority is to work professionally to give better product to the user.</p>
                        <div className='mt-5'>
                    ...
                    <div className='order-first md:order-last relative'>
                        <img src={Img} alt="" className='w-64 h-auto' />
                    </div>
                </div>
            </div>
